...
The `rasterizeGeneExpression` function allows you to rasterize gene expression at a resolution of your choosing. Below is an example of rasterizing gene expression by calculating the mean expression for all cells within each hexagonal pixel at 100 µm resolution.
